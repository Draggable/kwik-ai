!function(i) {
  ...
  i(document).ready(function() {
    ...
    function r(i, t) {
      s.removeClass("kwik-ai-status-connected kwik-ai-status-error").addClass(t ? "kwik-ai-status-error" : "kwik-ai-status-connected").text((t ? "✗ " : "✓ ") + i).show();
    }
    function c() {
    ...
    t.length && t.on("click", function(e) {
      ...
      e.prop("disabled", !0), s.removeClass("kwik-ai-status-connected kwik-ai-status-error").text(kwikAiSettings.strings.testing).show(),
      i.ajax({
        url: kwikAiSettings.ajaxUrl,
        type: "POST",
        data: a,
