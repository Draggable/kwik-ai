...
function kwik_ai_description_block_editor_assets()
{
  ...
  wp_enqueue_script(
    ...
    '2.6.3', // Increment version to force cache refresh
    true
  );
  ...
  wp_localize_script('kwik-ai-description-block', 'kwikAiDescriptionBlock', array(
    ...
    'strings' => array(
      ...
      'description' => __('Generate an AI-powered description based on post images', KWIK_AI_DOMAIN),
      ...
      'placeholder' => __('Click "Generate Description" to create an AI-powered description based on the images in this post.', KWIK_AI_DOMAIN),
      'error' => __('Failed to generate description. Please ensure Ollama is running and try again.', KWIK_AI_DOMAIN),
      'noImages' => __('No images found. Please add images to the post to generate a description.', KWIK_AI_DOMAIN),
    ),
  ));
